             ...
             <div class="col-lg-12">
                 <div class="card card-info">
                     <div class="card-header">
                         <h3 class="card-title"> Filter Rekapitulasi Perceraian</h3>
                     </div>
                     <div class="card-body">
                         <form class="form-inline">
                             <div class="form-group mb-2">
                                 <label for="periode" class="">Periode : </label>
                                 <input type="month" class="form-control ml-3 mr-3" name="periode" value="<?= set_value('periode') ?>">
                             </div>
                             <?php
                                $periode = NULL;
                 ...
                 <div class="row">
                     <div class="col-12">
                         <div class="card">
                                 <div class="card-header">
                                     <h3 class="card-title">Menampilkan laporan, <span class="font-weight-bold">periode: <span class="font-weight-bold"><?php echo $periode ?></span></h3>
                                 </div>
                             <div class="card-body">
