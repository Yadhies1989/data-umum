                     ...
                     <div class="col-12">
                         <div class="card card-info">
                             <div class="card-header">
                                 <h3 class="card-title"> Filter Putusan Verstek Tidak Tapi Di Amar Ada Kata Verstek </h3>
                             </div>
                             <div class="card-body">
                                 <form>
                                     <div class="card-header">
                         ...
                         <div class="card card-info">
                             <div class="card-header">
                                 <h3 class="card-title">Putusan Verstek Tidak Tapi Di Amar Ada Kata Verstek <strong><?php echo $ket; ?></strong></h3>
                             </div>
                             <!-- /.card-header -->
                             <div class="card-body">
                                 <?php
